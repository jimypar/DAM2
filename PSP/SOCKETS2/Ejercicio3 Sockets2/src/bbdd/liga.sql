...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-11-2021 a las 20:37:53
...
--
-- Estructura de tabla para la tabla `backupjugadores`
--

CREATE TABLE `backupjugadores` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `nacionalidad` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `idEquipo` int(11) NOT NULL,
  `posicion` varchar(80) COLLATE utf8_spanish2_ci NOT NULL,
  `individuo` varchar(80) COLLATE utf8_spanish2_ci NOT NULL
...
INSERT INTO `jugador` (`id`, `nombre`, `nacionalidad`, `idEquipo`, `posicion`) VALUES
(1, 'Cristiano Ronaldo', 'Portuguesa', 15, 'Delantero'),
(2, 'Gareth Bale', 'Galesa', 15, 'Delantero'),
(3, 'Lionel Messi', 'Argentina', 3, 'Delantero'),
(4, 'Neymar Jr', 'Brasileña', 3, 'Delantero'),
(5, 'Luka Modric', 'Croata', 15, 'Centrocampista'),
(6, 'Marcelo Vieira', 'Brasileño', 15, 'Lateral Izquierdo'),
(7, 'Isco', 'Española', 15, 'Centrocampista'),
(8, 'Raphael Varane', 'Francesa', 15, 'Defensa'),
(9, 'Toni Kroos', 'Alemana', 15, 'Centrocampista'),
(10, 'Dani carvajal', 'Española', 15, 'Lateral Derecho'),
(11, 'Gerard Piqué', 'Española', 3, 'Defensa'),
(12, 'Samuel Umtiti', 'Francesa', 3, 'Defensa'),
(13, 'Jordi Alba', 'Española', 3, 'Lateral Izquierdo'),
(14, 'Sergio Busquets', 'Española', 3, 'Centrocampista'),
(15, 'Jan Oblack', 'Eslovena', 2, 'Portero'),
(16, 'Koke Resurección', 'Española', 2, 'Centrocampista'),
(17, 'Ángel Corre', 'Argentina', 2, 'Delantero'),
(18, 'Joao Felix', 'Portuguesa', 2, 'Delantero'),
(19, 'José Luis Gayá', 'Española', 19, 'Lateral Izquierdo'),
(20, 'Gonçalo Guedes', 'Francesa', 19, 'Centrocampista'),
(21, 'Santi Cazorla', 'Española', 20, 'Centrocampista'),
(22, 'Sergio Asenjo', 'Española', 20, 'Portero');
...
--
-- Estructura de tabla para la tabla `updatejugadores`
--

CREATE TABLE `updatejugadores` (
  `id` int(11) NOT NULL,
  `nombre` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `nacionalidad` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `idEquipo` int(11) NOT NULL,
  `posicion` varchar(80) COLLATE utf8_spanish2_ci NOT NULL,
  `nombreNEW` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `nacionalidadNEW` varchar(100) COLLATE utf8_spanish2_ci NOT NULL,
  `idEquipoNEW` int(11) NOT NULL,
  `posicionNEW` varchar(80) COLLATE utf8_spanish2_ci NOT NULL,
  `individuo` varchar(80) COLLATE utf8_spanish2_ci NOT NULL,
  `fecha` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_spanish2_ci;
